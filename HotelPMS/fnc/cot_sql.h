/*
	...
	Query functions for checkout view definition
*/
...
int			Cot_Get_Inf( INH_INF_DAT *, int, WCHAR **, CDatabase *, PMS_MNG * );	// Getting reservation informations for checkin
int			Cot_Get_Dtl( Csr, int, WCHAR **, CDatabase *, PMS_MNG * );				// Getting reservation details for checkin
int			Cot_Rom_Rls( WCHAR *, Day *, WCHAR **, CDatabase *, PMS_MNG * );		// release the room
int			Cot_Chk_Out( int, int, WCHAR **, CDatabase *, PMS_MNG * );				// execute to checkout
